#2019 March Madness Bracketology
...
#Field Goal Attempts + 0.475 x free throw attempts - offensive rebounds + turnovers
...
########################################
#Max Phillips Kernal to Calculate TEAM season TOTALS
#Transforms Detailed Stats so that there is one row for each team by SEASON
...
#Add in Team Winning Percentage 
season_team_stats_tot$WinPerc <- season_team_stats_tot$wins / season_team_stats_tot$GP

#Max Phillips Kernal to Calculate TEAM season AVERAGES
...
#Performance Impact Estimator = Score + FGM + FTM - FGA - FTA + Defensive Rebounds + (0.5 * Offensive Rebounds) + Assists + Steals + (0.5 * Blocks) - PF - Turnovers
...
#Total Rebound = (Defensive Rebounds + Offensive Rebounds) / (Defensive Rebounds + Offensive Rebounds + Opponent's Defensive Rebounds + Opponent's Offensive Rebounds)
################################################################################################################################
...
#test1 <- read.csv("datafiles/MasseyOrdinals_thru_2019_day_128.csv", stringsAsFactors = FALSE)
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
#combined_stats_season_for_test <- combined_stats_season %>%
...
#join regular season stats to corresponding tourney teams 
train <- train %>% 
...
train <- train %>%
  ...
  rename(Season = Season.x,
         Team1_WinRate = WinPerc.x,
         Team2_WinRate = WinPerc.y,
         Team1_Wins = wins.x, 
         Team2_Wins = wins.y, 
         Team1_AstRatio = AstRatio.x, 
         Team2_AstRatio = AstRatio.y, 
         Team1_AvgBlk = Avg_Blk.x, 
         Team2_AvgBlk = Avg_Blk.y, 
         Team1_Avg_DR = Avg_DR.x, 
         Team2_Avg_DR = Avg_DR.y, 
         Team1_AvgAst = AvgAst.x, 
         Team2_AvgAst = AvgAst.y, 
         Team1_AvgAstAllow = AvgAstAllow.x, 
         Team2_AvgAstAllow = AvgAstAllow.y, 
         Team1_AvgBlkAllow = AvgBlkAllow.x, 
         Team2_AvgBlkAllow = AvgBlkAllow.y, 
         Team1_AvgDRAllow = AvgDRAllow.x, 
         Team2_AvgDRAllow = AvgDRAllow.y,
         Team1_Avg_FGA = AvgFGA.x, 
         Team2_Avg_FGA = AvgFGA.y, 
         Team1_Avg_FGA3 = AvgFGA3.x, 
         Team2_Avg_FGA3 = AvgFGA3.y, 
         Team1_Threes_Share = ThreesShare.x, 
         Team2_Threes_Share = ThreesShare.y, 
         Team1_SoS = SoS.x, 
         Team2_SoS = SoS.y, 
         Team1_Tie = Tie.x, 
         Team2_Tie = Tie.y, 
         Team1_TORatio = TORatio.x, 
         Team2_TORatio = TORatio.y, 
         Team1_TotPoints = TotPoints.x, 
         Team2_TotPoints = TotPoints.y,
         Team1_TotPointsAllow = TotPointsAllow.x, 
         Team2_TotPointsAllow = TotPointsAllow.y, 
         Team1_TotRebPerc = TotRebPerc.x, 
         Team2_TotRebPerc = TotRebPerc.y, 
         Team1_TSPerc = TSPerc.x, 
         Team2_TSPerc = TSPerc.y, 
         Team1_AvgFGA3Allow = AvgFGA3Allow.x, 
         Team2_AvgFGA3Allow = AvgFGA3Allow.y, 
         Team1_AvgFGA_Allow = AvgFGAAllow.x, 
         Team2_AvgFGA_Allow = AvgFGAAllow.y, 
         Team1_AvgFGM = AvgFGM.x, 
         Team2_AvgFGM = AvgFGM.y, 
         Team1_AvgFGM3 = AvgFGM3.x, 
         Team2_AvgFGM3 = AvgFGM3.y,
         Team1_PointsPerPossAllow = PointsPerPossAllow.x, 
         Team2_PointsPerPossAllow = PointsPerPossAllow.y, 
         Team1_PointsPerPoss = PointsPerPoss.x, 
         Team2_PointsPerPoss = PointsPerPoss.y, 
         Team1_Pie = Pie.x, 
         Team2_Pie = Pie.y, 
         Team1_OPie = Pie.x, 
         Team2_OPie = Pie.y, 
         Team1_OffRtg = OffRtg.x, 
         Team2_OffRtg = OffRtg.y, 
         Team1_GP = GP.x,
         Team2_GP = GP.y, 
         Team1_FTRate = FTRate.x, 
         Team2_FTRate = FTRate.y, 
         Team1_DefRtg = DefRtg.x, 
         Team2_DefRtg = DefRtg.y,
         Team1_DefRebPerc = DefRebPerc.x, 
         Team2_DefRebPerc = DefRebPerc.y, 
         Team1_AvgTOAllow = AvgTOAllow.x, 
         Team2_AvgTOAllow = AvgTOAllow.y, 
         Team1_AvgTO = AvgTO.x, 
         Team2_AvgTO = AvgTO.y, 
         Team1_AvgStlAllow = AvgStlAllow.x, 
         Team2_AvgStlAllow = AvgStlAllow.y, 
         Team1_AvgStl = AvgStl.x, 
         Team2_AvgStl = AvgStl.y, 
         Team1_AvgPossAllow = AvgPossAllow.x, 
         Team2_AvgPossAllow = AvgPossAllow.y, 
         Team1_AvgPoss = AvgPoss.x, 
         Team2_AvgPoss = AvgPoss.y, 
         Team1_AvgPointsAllow = AvgPointsAllow.x, 
         Team2_AvgPointsAllow = AvgPointsAllow.y, 
         Team1_AvgPoints = AvgPoints.x, 
         Team2_AvgPoints = AvgPoints.y, 
         Team1_AvgPFAllow = AvgPFAllow.x, 
         Team2_AvgPFAllow = AvgPFAllow.y, 
         Team1_AvgPF = AvgPF.x, 
         Team2_AvgPF = AvgPF.y, 
         Team1_AvgOT = AvgOT.x, 
         Team2_AvgOT = AvgOT.y, 
         Team1_AvgORAllow = AvgORAllow.x, 
         Team2_AvgORAllow = AvgORAllow.y, 
         Team1_AvgOR = AvgOR.x, 
         Team2_AvgOR = AvgOR.y, 
         Team1_AvgFTMAllow = AvgFTMAllow.x, 
         Team2_AvgFTMAllow = AvgFTMAllow.y, 
         Team1_AvgFTM = AvgFTM.x, 
         Team2_AvgFTM = AvgFTM.y, 
         Team1_AvgFTAAllow = AvgFTAAllow.x, 
         Team2_AvgFTAAllow = AvgFTAAllow.y, 
         Team1_AvgFTA = AvgFTA.x, 
         Team2_AvgFTA = AvgFTA.y, 
         Team1_AvgFGMAllow = AvgFGMAllow.x, 
         Team2_AvgFGMAllow = AvgFGMAllow.y, 
         Team1_AvgFGM3Allow = AvgFGM3Allow.x, 
         Team2_AvgFGM3Allow = AvgFGM3Allow.y, 
         Team1_Pomeroy = Pomeroy.x, 
         Team2_Pomeroy = Pomeroy.y, 
         Team1_Sagarin = Sagarin.x, 
         Team2_Sagarin = Sagarin.y
         ) 
